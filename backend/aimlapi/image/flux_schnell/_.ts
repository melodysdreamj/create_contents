...
export async function generateFluxSchnellImageUrl(prompt: string): Promise<string | null> {
    dotenv.config();
...
export async function downloadAndSaveFluxSchnellImage(imageUrl: string, savePath: string): Promise<string | null> {
    try {
