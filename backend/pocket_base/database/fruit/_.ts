    ...
    static async createTable() {
        ...
        const collectionData = {
            ...
            schema: [
                ...
                // {name: 's007', type: 'text', required: false},
                // {name: 's008', type: 'text', required: false},
                // {name: 's009', type: 'text', required: false},
                // {name: 's010', type: 'text', required: false},
                // {name: 's011', type: 'text', required: false},
                // {name: 's012', type: 'text', required: false},
                // {name: 's013', type: 'text', required: false},
                // {name: 's014', type: 'text', required: false},
                // {name: 's015', type: 'text', required: false},
                // {name: 's016', type: 'text', required: false},
                // {name: 's017', type: 'text', required: false},
                // {name: 's018', type: 'text', required: false},
                // {name: 's019', type: 'text', required: false},
                // {name: 's020', type: 'text', required: false},
                // {name: 's021', type: 'text', required: false},
                // {name: 's022', type: 'text', required: false},
                // {name: 's023', type: 'text', required: false},
                // {name: 's024', type: 'text', required: false},
                // {name: 's025', type: 'text', required: false},
                // {name: 's026', type: 'text', required: false},
                // {name: 's027', type: 'text', required: false},
                // {name: 's028', type: 'text', required: false},
                // {name: 's029', type: 'text', required: false},
                // {name: 's030', type: 'text', required: false},
                // {name: 's031', type: 'text', required: false},
                // {name: 's032', type: 'text', required: false},
                // {name: 's033', type: 'text', required: false},
                // {name: 's034', type: 'text', required: false},
                // {name: 's035', type: 'text', required: false},
                // {name: 's036', type: 'text', required: false},
                // {name: 's037', type: 'text', required: false},
                // {name: 's038', type: 'text', required: false},
                // {name: 's039', type: 'text', required: false},
                // {name: 's040', type: 'text', required: false},
                // {name: 's041', type: 'text', required: false},
                // {name: 's042', type: 'text', required: false},
                // {name: 's043', type: 'text', required: false},
                // {name: 's044', type: 'text', required: false},
                // {name: 's045', type: 'text', required: false},
                // {name: 's046', type: 'text', required: false},
                // {name: 's047', type: 'text', required: false},
                // {name: 's048', type: 'text', required: false},
                // {name: 's049', type: 'text', required: false},
                // {name: 's050', type: 'text', required: false},
                // {name: 's051', type: 'text', required: false},
                // {name: 's052', type: 'text', required: false},
                // {name: 's053', type: 'text', required: false},
                // {name: 's054', type: 'text', required: false},
                // {name: 's055', type: 'text', required: false},
                // {name: 's056', type: 'text', required: false},
                // {name: 's057', type: 'text', required: false},
                // {name: 's058', type: 'text', required: false},
                // {name: 's059', type: 'text', required: false},
                // {name: 's060', type: 'text', required: false},
                // {name: 's061', type: 'text', required: false},
                // {name: 's062', type: 'text', required: false},
                // {name: 's063', type: 'text', required: false},
                // {name: 's064', type: 'text', required: false},
                // {name: 's065', type: 'text', required: false},
                // {name: 's066', type: 'text', required: false},
                // {name: 's067', type: 'text', required: false},
                // {name: 's068', type: 'text', required: false},
                // {name: 's069', type: 'text', required: false},
                // {name: 's070', type: 'text', required: false},
                // {name: 's071', type: 'text', required: false},
                // {name: 's072', type: 'text', required: false},
                // {name: 's073', type: 'text', required: false},
                // {name: 's074', type: 'text', required: false},
                // {name: 's075', type: 'text', required: false},
                // {name: 's076', type: 'text', required: false},
                // {name: 's077', type: 'text', required: false},
                // {name: 's078', type: 'text', required: false},
                // {name: 's079', type: 'text', required: false},
                // {name: 's080', type: 'text', required: false},
                // {name: 's081', type: 'text', required: false},
                // {name: 's082', type: 'text', required: false},
                // {name: 's083', type: 'text', required: false},
                // {name: 's084', type: 'text', required: false},
                // {name: 's085', type: 'text', required: false},
                // {name: 's086', type: 'text', required: false},
                // {name: 's087', type: 'text', required: false},
                // {name: 's088', type: 'text', required: false},
                // {name: 's089', type: 'text', required: false},
                // {name: 's090', type: 'text', required: false},
                // {name: 's091', type: 'text', required: false},
                // {name: 's092', type: 'text', required: false},
                // {name: 's093', type: 'text', required: false},
                // {name: 's094', type: 'text', required: false},
                // {name: 's095', type: 'text', required: false},
                // {name: 's096', type: 'text', required: false},
                // {name: 's097', type: 'text', required: false},
                // {name: 's098', type: 'text', required: false},
                // {name: 's099', type: 'text', required: false},
                ...
                // {name: 'l001', type: 'text', required: false},
                // {name: 'l002', type: 'text', required: false},
                // {name: 'l003', type: 'text', required: false},
                // {name: 'l004', type: 'text', required: false},
                // {name: 'l005', type: 'text', required: false},
                // {name: 'l006', type: 'text', required: false},
                // {name: 'l007', type: 'text', required: false},
                // {name: 'l008', type: 'text', required: false},
                // {name: 'l009', type: 'text', required: false},
                // {name: 'l010', type: 'text', required: false},
                // {name: 'l011', type: 'text', required: false},
                // {name: 'l012', type: 'text', required: false},
                // {name: 'l013', type: 'text', required: false},
                // {name: 'l014', type: 'text', required: false},
                // {name: 'l015', type: 'text', required: false},
                // {name: 'l016', type: 'text', required: false},
                // {name: 'l017', type: 'text', required: false},
                // {name: 'l018', type: 'text', required: false},
                // {name: 'l019', type: 'text', required: false},
                // {name: 'l020', type: 'text', required: false},
                // {name: 'm000', type: 'text', required: false},
                // {name: 'm001', type: 'text', required: false},
                // {name: 'm002', type: 'text', required: false},
                // {name: 'm003', type: 'text', required: false},
                // {name: 'm004', type: 'text', required: false},
                // {name: 'm005', type: 'text', required: false},
                // {name: 'm006', type: 'text', required: false},
                // {name: 'm007', type: 'text', required: false},
                // {name: 'm008', type: 'text', required: false},
                // {name: 'm009', type: 'text', required: false},
                // {name: 'm010', type: 'text', required: false},
                // {name: 'm011', type: 'text', required: false},
                // {name: 'm012', type: 'text', required: false},
                // {name: 'm013', type: 'text', required: false},
                // {name: 'm014', type: 'text', required: false},
                // {name: 'm015', type: 'text', required: false},
                // {name: 'm016', type: 'text', required: false},
                // {name: 'm017', type: 'text', required: false},
                // {name: 'm018', type: 'text', required: false},
                // {name: 'm019', type: 'text', required: false},
                // {name: 'm020', type: 'text', required: false},
                // {name: 'c000', type: 'text', required: false},
                // {name: 'c001', type: 'text', required: false},
                // {name: 'c002', type: 'text', required: false},
                // {name: 'c003', type: 'text', required: false},
                // {name: 'c004', type: 'text', required: false},
                // {name: 'c005', type: 'text', required: false},
                // {name: 'c006', type: 'text', required: false},
                // {name: 'c007', type: 'text', required: false},
                // {name: 'c008', type: 'text', required: false},
                // {name: 'c009', type: 'text', required: false},
                // {name: 'c010', type: 'text', required: false},
                // {name: 'c011', type: 'text', required: false},
                // {name: 'c012', type: 'text', required: false},
                // {name: 'c013', type: 'text', required: false},
                // {name: 'c014', type: 'text', required: false},
                // {name: 'c015', type: 'text', required: false},
                // {name: 'c016', type: 'text', required: false},
                // {name: 'c017', type: 'text', required: false},
                // {name: 'c018', type: 'text', required: false},
                // {name: 'c019', type: 'text', required: false},
                // {name: 'c020', type: 'text', required: false},
                // {name: 'j000', type: 'text', required: false},
                // {name: 'j001', type: 'text', required: false},
                // {name: 'j002', type: 'text', required: false},
                // {name: 'j003', type: 'text', required: false},
                // {name: 'j004', type: 'text', required: false},
                // {name: 'j005', type: 'text', required: false},
                // {name: 'j006', type: 'text', required: false},
                // {name: 'j007', type: 'text', required: false},
                // {name: 'j008', type: 'text', required: false},
                // {name: 'j009', type: 'text', required: false},
                // {name: 'j010', type: 'text', required: false},
                // {name: 'j011', type: 'text', required: false},
                // {name: 'j012', type: 'text', required: false},
                // {name: 'j013', type: 'text', required: false},
                // {name: 'j014', type: 'text', required: false},
                // {name: 'j015', type: 'text', required: false},
                // {name: 'j016', type: 'text', required: false},
                // {name: 'j017', type: 'text', required: false},
                // {name: 'j018', type: 'text', required: false},
                // {name: 'j019', type: 'text', required: false},
                // {name: 'j020', type: 'text', required: false},
                // {name: 'e000', type: 'text', required: false},
                // {name: 'e001', type: 'text', required: false},
                // {name: 'e002', type: 'text', required: false},
                // {name: 'e003', type: 'text', required: false},
                // {name: 'e004', type: 'text', required: false},
                // {name: 'e005', type: 'text', required: false},
                // {name: 'e006', type: 'text', required: false},
                // {name: 'e007', type: 'text', required: false},
                // {name: 'e008', type: 'text', required: false},
                // {name: 'e009', type: 'text', required: false},
                // {name: 'e010', type: 'text', required: false},
                // {name: 'e011', type: 'text', required: false},
                // {name: 'e012', type: 'text', required: false},
                // {name: 'e013', type: 'text', required: false},
                // {name: 'e014', type: 'text', required: false},
                // {name: 'e015', type: 'text', required: false},
                // {name: 'e016', type: 'text', required: false},
                // {name: 'e017', type: 'text', required: false},
                // {name: 'e018', type: 'text', required: false},
                // {name: 'e019', type: 'text', required: false},
                // {name: 'e020', type: 'text', required: false},
                {
