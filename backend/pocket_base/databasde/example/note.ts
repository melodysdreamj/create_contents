import {Example, ExamplePocketBaseCollection} from "./example";
import {Sub} from "./sub";
...
async function main() {
    ...
    await ExamplePocketBaseCollection.upsert(check);

    let check2 = await ExamplePocketBaseCollection.get('example');
