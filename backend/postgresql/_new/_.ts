...
export class New {
  ...
  static fromMap(queryParams: any): New {
    ...
    // object.t001 = new Date(parseInt(queryParams.t001) || 0);
    // object.t002 = new Date(parseInt(queryParams.t002) || 0);
    // object.t003 = new Date(parseInt(queryParams.t003) || 0);
    // object.t004 = new Date(parseInt(queryParams.t004) || 0);
    // object.t005 = new Date(parseInt(queryParams.t005) || 0);
    // object.t006 = new Date(parseInt(queryParams.t006) || 0);
    // object.t007 = new Date(parseInt(queryParams.t007) || 0);
    // object.t008 = new Date(parseInt(queryParams.t008) || 0);
    // object.t009 = new Date(parseInt(queryParams.t009) || 0);
    // object.t010 = new Date(parseInt(queryParams.t010) || 0);
    // object.t011 = new Date(parseInt(queryParams.t011) || 0);
    // object.t012 = new Date(parseInt(queryParams.t012) || 0);
    // object.t013 = new Date(parseInt(queryParams.t013) || 0);
    // object.t014 = new Date(parseInt(queryParams.t014) || 0);
    // object.t015 = new Date(parseInt(queryParams.t015) || 0);
    // object.t016 = new Date(parseInt(queryParams.t016) || 0);
    // object.t017 = new Date(parseInt(queryParams.t017) || 0);
    // object.t018 = new Date(parseInt(queryParams.t018) || 0);
    // object.t019 = new Date(parseInt(queryParams.t019) || 0);
    // object.t020 = new Date(parseInt(queryParams.t020) || 0);
    // object.l000 = JSON.parse(queryParams.l000 || '[]');
    // object.l001 = JSON.parse(queryParams.l001 || '[]');
    // object.l002 = JSON.parse(queryParams.l002 || '[]');
    // object.l003 = JSON.parse(queryParams.l003 || '[]');
